...
if [ -d ~/.config/opencode/superpowers ]; then
  ...
  git clone https://github.com/Roman-Blinkov/superpowers.git ~/.config/opencode/superpowers
fi
...
git clone https://github.com/Roman-Blinkov/superpowers.git "%USERPROFILE%\.config\opencode\superpowers"
...
```powershell
# 1. Install Superpowers
git clone https://github.com/Roman-Blinkov/superpowers.git "$env:USERPROFILE\.config\opencode\superpowers"
